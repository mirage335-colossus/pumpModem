...
vertex VertexOut vertex_main(
    ...
    float2 expandedSize = float2(data.w, data.h) + float2(shadowExtent * 2.0f);
    float2 expandedPos = float2(data.shadowX, data.shadowY) + expandedOrigin + cornerOffset * expandedSize;
