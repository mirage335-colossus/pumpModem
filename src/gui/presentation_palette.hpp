...
inline constexpr Rgb text_rgb(ui::TextTone tone, bool use_color) {
    switch(tone) {
...
inline constexpr Rgb text_rgb(ui::DocumentTone tone, bool use_color) {
    switch(tone) {
...
inline constexpr std::optional<Rgb> document_fill_rgb(ui::DocumentFill fill, bool action = false) {
    switch(fill) {
