...
void details(Node& root,const planner::Model& model) {
    ...
    paragraph(n, "Red indicators. RX estimates below 80% and observer / receiver times below 8× are red. The 8× cutoff is a listening guideline, not a validated acoustic threshold.");
